...
const Navbar = () => {
    ...
    return (
        <div className="flex items-center justify-center">
            <nav className="w-11/12 mt-5 bg-[#262A43] rounded-xl shadow-[8px_9px_0px_rgba(0,0,0)]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16">
                        <div className="flex items-center w-full">
                            <div className="flex-shrink-0">
                                <a href="/">
                                    <div className='font-main flex items-center justify-center text-[40px] text-white'><span className="navbarfont">Vibrance'23</span></div>
                                </a>
                            </div>
